...
export function Register() {
  ...
  const onRegister = async () => {
    ...
    if (roleId === "6" && !courseId) return toast.warn("Select course");

    // Convert roleId and courseId to numbers before sending
    const result = await facultyRegister(
      name,
      email,
      password,
      parseInt(roleId),
      ...
      <div className="row">
        ...
        <div className="col">
          <div className="form">
            ...
            {/* Course - only visible for Course Coordinator */}
            {roleId === "6" && (
              <div className="mb-3">
                <label>Course</label>
                <select
